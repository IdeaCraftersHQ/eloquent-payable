 ...
 * @method static Payment cancel(Payment $payment, ?string $reason = null)
 ...
 * @method static \Illuminate\Database\Eloquent\Collection getCanceledPayments()
 ...
 * @method static void markAsCanceled(Payment $payment, string $reason = null)
 ...
 * @method static bool isCanceled(Payment $payment)
